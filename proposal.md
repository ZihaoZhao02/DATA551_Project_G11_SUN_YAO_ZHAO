...
**RQ2: How are performance characteristics associated with sales patterns across vehicle segments?**  
We aim to investigate whether engine performance features (treating horsepower as a continuous variable and turbocharging as a binary variable) are differently represented across models and fuel types. By examining how horsepower levels and turbo configurations are distributed among sold vehicles, we aim to understand how performance characteristics are reflected in market offerings.
